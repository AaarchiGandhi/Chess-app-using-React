...
for(let p = 0; p < 2; p++){
    ...
    initialBoardState.push({image : `assets/images/king_${type}.png`, x: 3, y , type : PieceType.KING, team : teamType});
    initialBoardState.push({image : `assets/images/queen_${type}.png`, x:4, y , type : PieceType.QUEEN, team : teamType });
}
